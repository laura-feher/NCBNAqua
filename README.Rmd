...
The function save_water_level_with_datums() will save the water level data, tidal datums, and plot to an excel file. Note that the data must either be filtered to a single site before using the function or you must use the 'site' parameter within the function to filter the data to a single site.
