...
#' 
#' @details
#' Adapted from https://github.com/AndrewBirchHydro/albAquariusTools
#' 
#' @field version character. AQTS version. 
#' @field publishUri character. Base URI for all API endpoints. 
#' @field acquisitionUri character. base URI for all API endpoints. 
#' @field provisioningUri character. base URI for all API endpoints. 
#' @field legacyPublishUri character. legacy base URI for all API endpoints. 
#' @field legacyAcquisitionUri character. legacy base URI for all API endpoints. 
#' @field isLegacy logical. Anything earlier than 14.3 is considered legacy code.
#' 
#' @import jsonlite
#' @import httr
#' @import dplyr
...
#' @export
#' 
#' @note Most of this was adapted from Dean Tucker's (NPS-WRD) tools for accessing Aquarius TS data.
#' 
timeseriesClient <- setRefClass("timeseriesClient",
                                ...
                                methods = list(
                                  ...
                                  #' 
                                  #' @param timeSeriesIdentifier time series identifier
